...
this.dispatch = function(req, res) {
  //fs.writeFile('../logs/log.txt', JSON.stringify(req), function(err) {
  //  if (err) throw err;
 //});
  // allow cross-origin requests  
  // if (typeof res.header != 'undefined' && res.header != null){
    ...
    */
    ...
    switch (controller_name) {
      ...
      case "data":
        ...
        util.extractPostData(req, function(post) {
              util.merge(parameters,post);
              fs.appendFile("./logs/log.txt", JSON.stringify(parameters) + "\n\n", function(err) {
                if (err) throw err;
                console.log("saved data params to file!");
              });
              callController(controller_name, action, parameters); 
              });    
        }

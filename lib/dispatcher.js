...
this.dispatch = function(req, res) {
  ...
  if (requestedUrl.pathname == '/') {
    ...
    if (requestedUrl.pathname.indexOf(".") > 0) {
  ...
  console.log("requestUrl.pathname is " + requestedUrl.pathname);

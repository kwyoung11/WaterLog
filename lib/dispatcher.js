    ...
    switch (controller_name) {
      ...
      case "mobile":
        if (requestedUrl.pathname.match(/\/mobile\/([0-9]+)\/input/) && req.method == "GET") {
          ...
          }else if (requestedUrl.pathname.match(/\/mobile\/[0-9]+\/water/) && req.method == "GET") {
            action = "input_type";
            parameters['device_id'] = parts[2];
            parameters['data_type'] = "water";
            callController(controller_name, action, parameters);
          }else if (requestedUrl.pathname.match(/\/mobile\/[0-9]+\/soil/) && req.method == "GET") {
            action = "input_type";
            parameters['device_id'] = parts[2];
            parameters['data_type'] = "soil";
            callController(controller_name, action, parameters);
          }else if (requestedUrl.pathname.match(/\/mobile\/[0-9]+\/air/) && req.method == "GET") {
            action = "input_type";
            parameters['device_id'] = parts[2];
            parameters['data_type'] = "air";
            callController(controller_name, action, parameters);
          }
